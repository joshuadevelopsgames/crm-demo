/**
 * Admin endpoint to manually trigger full notification refresh
 * This does everything the cron job does, but uses admin auth instead of CRON_SECRET
...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log(`🔄 Admin ${user.email} manually triggering notification refresh...`);
